...
exports.registerStudent = async (req, res) => {
  try {
    const {
      ...
      branch, studyYear, institution, city, programInterest,
    ...
    const studentData = {
      ...
      currentStatus, branch, studyYear, institution, city,
      programInterest, salesSelections, craSelections, agreeTerms
    };
    ...
    res.status(201).json({
      ...
      data: { id: studentId, email, firstName, lastName },
      token
    });
  } catch (error) {
...
exports.loginStudent = async (req, res) => {
  try {
    ...
    res.status(200).json({
      ...
      data: { id: student.id, email: student.email, firstName: student.first_name },
      token
    });
  } catch (error) {
